...
def main(_data_folder,_rez_fn,_sensi_bound):
    """
        ...
        :return: no returns.
    """
    # generate all the real data set name list
    datasets=['ProPublica','GermanCredit']

    # generate the sensitive attribute mapping dictionary
    sensi_atts_dic={}
    sensi_atts_dic['ProPublica']=['race','sex']
    sensi_atts_dic['GermanCredit']=['sex','age25','age35']
    # generate the noweight attributes mapping dictionary
    noweight_atts_dic={}
    ...
    # generate the reverse attributes mapping dictionary
    reverse_atts_dic={}
    ...
    # generate the split flag mapping dictionary
    cutpoint_dic={}
    ...
    with open(rez_fn,'w') as mf:
        mf.write("Dataset,UserNumber,SensitiveATT,SNumber,SNpercent,TargetAtt,GF1value,GF2value,GF3value\n")
