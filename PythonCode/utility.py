...
def readCSV(_data_fn,_target_cols, _sensi_bound): 
    """
        ...
        :param _target_cols: The target column ranked on, value from [0,col(_data_fn)-2] since sensitve attribute is on last column
    ...
    if _target_cols > (att_N-2) or _target_cols < 0:
...
def calculateWeightedScores(_data): 
    """
        Calculate a list of scores by equally weighted summation of all the attributes in the input _data.
